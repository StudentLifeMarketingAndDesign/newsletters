...
table.twelve center { min-width: 600px; }
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            ...
                            <% if Feature1URL %><a href="{$Feature1URL}"><% end_if %>
                              <img src="$BaseHref$Feature1Image.URL" alt="" border="0" width="600" height="$Feature1Image.Height"></a>
                            <% if Feature1URL %></a><% end_if %>
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            ...
                            <% if Feature2URL %><a href="{$Feature2URL}"><% end_if %>
                              <img src="$BaseHref$Feature2Image.URL" alt="" border="0" width="600" height="$Feature2Image.Height"></a>
                            <% if Feature2URL %></a><% end_if %>
                      ...
                      <table class="six columns">
                        <tr>
                          <td class="left-text-pad">
                            ...
                            <a href="http://www.hawkshop.com/ePOS/form=shared3/gm/browse.html&cat=640"><img title="" src="http://imu.uiowa.edu/assets/wrbnewsletter.gif" alt="wrb logo" width="275" height="45" align="left" /></a>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td align="center">
                            <center>
                              <p style="text-align:center;"><a href="https://list.uiowa.edu/scripts/wa.exe?SUBED1=WILD-ROSE-BOOKS&amp;A=1"><unsubscribe>Unsubscribe</unsubscribe></a></p>
                            </center>
                          </td>
                          <td class="expander"></td>
                        </tr>
