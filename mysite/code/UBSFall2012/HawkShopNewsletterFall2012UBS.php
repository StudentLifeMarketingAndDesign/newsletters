 ...
 */
class HawkShopNewsletterFall2012UBS extends Page {
...
function getCMSFields() {
	...
	$fields->addFieldToTab('Root.Main', new ImageField('MainImage', 'Main Feature Image - 600px wide'));
	$fields->addFieldToTab('Root.Main', new TextField('MainImageURL', 'Main Image URL (hawkshop.com pages)'));
	...
	/* Feature 1 content */
	$fields->addFieldToTab('Root.Feature1', new ImageField('Feature1Image', 'Feature 1 Image - 600px wide'));
	...
	/* Feature 2 content */
	$fields->addFieldToTab('Root.Feature2', new ImageField('Feature2Image', 'Feature 2 Image - 600px wide'));
	...
	/* Feature 3 content */
	$fields->addFieldToTab('Root.Feature3', new ImageField('Feature3Image', 'Feature 3 Image - 600px wide'));
...
class HawkShopNewsletterFall2012UBS_Controller extends ContentController {
