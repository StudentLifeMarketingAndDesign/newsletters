 ...
 */
class TCNewsletterNew extends Page {
...
function getCMSFields() {
	...
	/* Feature 1 content */
	$fields->addFieldToTab('Root.Content.Feature1', new UploadField('Feature1Image', 'Feature 1 Image - 150 x 110 pixels'));
	...
	/* Feature 2 content */
	$fields->addFieldToTab('Root.Content.Feature2', new UploadField('Feature2Image', 'Feature 2 Image - 150 x 110 pixels'));
	...
	/* Feature 3 content */
	$fields->addFieldToTab('Root.Content.Feature3', new UploadField('Feature3Image', 'Feature 3 Image - 150 x 110 pixels'));
	...
	/* Feature 4 content */
	$fields->addFieldToTab('Root.Content.Feature4', new UploadField('Feature4Image', 'Feature 4 Image - 150 x 110 pixels'));
	...
	/* Feature 5 content */
	$fields->addFieldToTab('Root.Content.Feature5', new UploadField('Feature5Image', 'Feature 5 Image - 150 x 110 pixels'));
	...
	/* Feature 6 content */
	$fields->addFieldToTab('Root.Content.Feature6', new UploadField('Feature6Image', 'Feature 6 Image - 150 x 110 pixels'));
	...
	/* Feature 7 content */
	$fields->addFieldToTab('Root.Content.Feature7', new UploadField('Feature7Image', 'Feature 7 Image - 150 x 110 pixels'));
	...
	/* Feature 8 content */
	$fields->addFieldToTab('Root.Content.Feature8', new UploadField('Feature8Image', 'Feature 8 Image - 150 x 110 pixels'));
	...
	/* Feature 9 content */
	$fields->addFieldToTab('Root.Content.Feature9', new UploadField('Feature9Image', 'Feature 9 Image - 150 x 110 pixels'));
	...
	$fields->addFieldToTab('Root.Content.Feature9', new HTMLEditorField('Feature9Text', 'Feature 9 Text'));
...
class TCNewsletterNew_Controller extends ContentController {
